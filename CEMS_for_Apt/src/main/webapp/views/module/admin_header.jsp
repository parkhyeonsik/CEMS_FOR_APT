...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light bg-gray-dark">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> 1 민원이 들어왔습니다.
            <span class="float-right text-muted text-sm">10:13 AM</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <img src="<%=request.getContextPath() %>/resources/img/charging-station.png" alt="Icon" width="25" height="25" > 이상 온도 감지
            <span class="float-right text-muted text-sm">11:13 AM</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <img src="<%=request.getContextPath() %>/resources/img/warning.png" alt="Icon" width="25" height="25" > 충전기 이상
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">EV System</span>
    </a>
