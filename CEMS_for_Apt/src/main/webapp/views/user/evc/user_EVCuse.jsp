      ...
      <div class="row md-2">
         ...
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">충전기 사용</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <div class="col-md-8">
               <div class="card card-info">
                  <div class="card-header">
                     <h3 class="card-title">충전기 사용설정</h3>
                  ...
                  <div class="register-card-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                           <input name="num2" type="text" class="form-control"
                              id="num2" value="사용가능" readonly="">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="inputPassword3"
                           class="col-sm-3 control-label text-right">설정 충전량</label>
                        <div class="col-sm-7">
                     ...
                     <div class="form-group row">
                        <label for="inputPassword3"
                           class="col-sm-3 control-label text-right">충전 속도</label>
                        <div class="col-sm-7">
                           <input name="num4" type="text" class="form-control"
                              id="num4" value="7kW" readonly="">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="inputPassword3"
                        ...
                        <div class="col-sm-7">
                           <input name="num5" type="text" class="form-control"
                              id="num5" value="08시간 13분 " readonly="">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="inputPassword3"
                        ...
                        <div class="col-sm-7">
                   		...
                   		<div class="col-sm-12">
                   		  ...
                   		  <button type= "button"  class="col-sm-2 form-control float-right" onclick="alert('충전설정을 완료하시겠습니까?')">충전기 사용</button>
