...
<body>
   ...
   <div class="container-fluid">
      <div class="row md-2">
         <div class="col-sm-6">사용중인 충전기</div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="#"> <i
                     class="fa fa-dashboard">충전기</i>
               </a></li>
               <li class="breadcrumb-item active">사용중인 충전기</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <div class="col-md-8">
               <div class="card card-info">
                  <div class="card-header">
                     <h3 class="card-title">사용중인 충전기</h3>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                           <input name="num4" type="text" class="form-control"
                              id="num4" value="30kW" readonly="">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="inputPassword3"
                           class="col-sm-3 control-label text-right">충전 시간</label>
                        <div class="col-sm-7">
                           <input name="num5" type="text" class="form-control"
                              id="num5" value="02시간 13분 " readonly="">
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="inputPassword3"
                        ...
                        <div class="col-sm-7">
                           <input name="num6" type="text" class="form-control"
                              id="num6" value="01시간 28분" readonly="">
                        </div>
                     </div>
                   		...
                   		<div class="col-sm-12">
                   		  ...
                   		  <button type= "button"  class="col-sm-2 form-control float-right" onclick="alert('충전을 종료 하시겠습니까?')">충전 종료</button>
